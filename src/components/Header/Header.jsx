      ...
      <div className="relative z-30 text-2x h-full w-full flex flex-col items-center justify-center sm:px-8 py-36 md:px-36">
        <div className="flex flex-col items-center">
          ...
          <p className="text-paragraph font-light w-3/4 m-4">
            Aprovecha todo el poder de la inteligencia artificial en tu
            WhatsApp. Investiga, aprende o simplemente diviértete preguntando lo
            que quieras.
          </p>
        ...
        <p className="text-paragraph text-3xl font-light m-4 w-full">
          ...
          <span className="text-title">
            experiencia más práctica y sencilla
          </span>. Así que no lo pienses más y comienza a preguntar lo que
          quieras.
        </p>
      </div>
      <video
