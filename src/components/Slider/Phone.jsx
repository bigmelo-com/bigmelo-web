...
export default function Phone(example) {
  ...
  return (
    <>
        <div className="bg-phoneBody rounded-3xl min-h-[620px] max-h-[620px] min-w-[328px] max-w-[328px] overflow-hidden flex flex-col self-center">
            ...
            <div className="bg-button max-h-[72px] py-5 pl-6 flex items-center">
              ...
              <Example {...example} id={example.id} className='m-3 flex flex-col space-y-4 text-white content-end grow justify-end overflow-hidden min-h-[452px]' />
